...
export const TRANSLATIONS: Record<SupportedLang, TranslationSchema> = {
  en: {
    ...
    whatsappMessages: {
      ...
      trial: "Hi! I'd like to activate my One-Day Free Trial",
  ...
  pt: {
    ...
    whatsappMessages: {
      ...
      trial: "Oi! Gostaria de ativar meu teste gratuito de 1 dia",
  ...
  es: {
    ...
    whatsappMessages: {
      ...
      trial: "¡Hola! Me gustaría activar mi prueba gratuita de 1 día",
